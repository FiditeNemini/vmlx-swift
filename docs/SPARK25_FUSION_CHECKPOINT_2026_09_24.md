...
- The replacement still slowed a complete 7,032-token parsed hash-table response to 72.3 tok/s. The same binary with reference activation completed at 94.0 tok/s. Both stopped natively with closed reasoning and matching visible answer. The remaining dispatch/runtime interaction is unresolved; do not promote this default decode path.
